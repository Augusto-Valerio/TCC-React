    ...
    <div className="font-inter bg-body">  
      ...
      <div className="flex justify-center items-center ">
        ...
        <section className="text-texto flex flex-col items-center w-4/5 h-[741px] mt-8" >
            ...
            <p className=" text-center  text-xl leading-6 mt-8 border border-rounded  rounded-lg w-1/2  px-3 pt-4 pb-4   text-center text-texto">
      ...
      <footer className="flex items-center justify-center text-texto w-full h-24 bg-navbar-footer mt-40 gap-8 " /* #DCDCE1 texto do footer.*/  /* #1A1A1E cor de fundo do footer */>
        <p>
          Fale conosco: 
        </p>
